...
namespace Renter.Infrastructure.Services
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<RenterException, Task> _onCustomError;

        private bool _propagateExceptions = false;

        private bool _executeOnError = false;
        ...
        public IHandlerTask OnCustomError(Func<RenterException, Task> onCustomError, bool propagateException = false, bool executeOnError = false)
        {
            _onCustomError = onCustomError;
            _propagateExceptions = propagateException;
        ...
        {
            var customException = exception as RenterException;
